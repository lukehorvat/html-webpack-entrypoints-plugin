...
const RUNTIME_ENTRYPOINT_NAME = '_runtime';
...
class HtmlWebpackEntrypointsPlugin {
  ...
  /**
   * Get the JS/CSS assets across all entry points.
   */
  ...
  /**
   * Get the JS/CSS assets for a given entry point.
   */
  ...
  /**
   * Get the JS/CSS assets for a given chunk.
   */
  ...
  /**
   * Get the runtime chunks across all entry points.
   */
